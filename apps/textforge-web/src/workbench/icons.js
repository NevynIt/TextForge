...
export function createWelcomeView() {
  return {
    ...
    summary: 'The workbench is ready to open editable text resources, bundled read-only examples, package-owned previews, and generated workspace outputs.',
    openWith: 'Editor and viewer surfaces',
    state: 'open',
    placement: 'main',
    controls: [],
  };
