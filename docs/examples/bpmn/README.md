# TextForge BPMN Examples

This folder contains bundled BPMN reference assets used by the active roadmap and BPMN grilling records.
...
These files are intentionally broader than the accepted `WP-BPMN-SEM` MVP. The roadmap links them to future gates such as `WP-BPMN-DI-01`, `WP-BPMN-VISUAL-B`, `WP-VITM-TRANSLATORS`, and later BPMN semantic expansion work.
