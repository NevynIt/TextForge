...
- `ARCH-10-P03` — lines 3243–3258: ```text roadmap/AGENTS_START_HERE.md First operational instructions for every coding agent run. roadmap/ROADMAP_V20.md Active roadmap baseline and operator entrypoint. roadmap/workpackages/workpackage-register.md Authoritative workpackage register...
...
- `ARCH-13.3-P03` — lines 3605–3608: - `roadmap/ROADMAP_V20.md` for the active roadmap baseline. - `roadmap/workpackages/workpackage-register.md` for authoritative workpackage register and dependency posture. - `roadmap/decisions/RAPID.md` for append-only status history...
