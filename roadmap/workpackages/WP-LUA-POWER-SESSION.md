# WP-LUA-POWER-SESSION - Lua self-escalation session and one-click recovery
...
Use `validation/checklists/workpackages/WP-LUA-POWER-SESSION-self-escalation-session-recovery.md` plus release-specific evidence.
