...
| Next implementation options | `WP-RES-01`; `WP-ID-01`, `WP-SET-01`, `WP-ITM-02`, `WP-ITM-VISUALS`, and `WP-TABLES` are startable. `WP-LUA-POWER-SESSION` is now validated on top of `WP-LUA`. Selection order is chosen one slice at a time. |
