...
| Next implementation options | `WP-RES-01`; `WP-ID-01`, `WP-SET-01`, `WP-ITM-02`, `WP-ITM-VISUALS`, `WP-TABLES`, and candidate `WP-LUA-POWER-SESSION` are startable. Selection order is chosen one slice at a time. |
...
| WP-LUA-POWER-SESSION | Candidate | `roadmap/workpackages/WP-LUA-POWER-SESSION-RECOVERY.md` | 2026-05-27 | Candidate follow-on to `WP-LUA`: session-scoped elevated host-object access, visible console badge, no auto-expire, and one-click recovery with a one-shot Lua-preload skip. |
