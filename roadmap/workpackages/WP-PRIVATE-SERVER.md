# WP-PRIVATE-SERVER - Private/group spaces server

## Registry

- Workpackage ID: `WP-PRIVATE-SERVER`
...
Depends on policy enforcement, not specifically Entra.
