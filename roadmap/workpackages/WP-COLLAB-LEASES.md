# WP-COLLAB-LEASES - Soft collaboration leases

## Registry

- Workpackage ID: `WP-COLLAB-LEASES`
...
Time-bound advisory leases only; no live collaboration.
