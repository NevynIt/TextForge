# WP-ARCHIMATE-VISUAL - ArchiMate visual editing investigation

## Registry

- Workpackage ID: `WP-ARCHIMATE-VISUAL`
- Authoritative state: `roadmap-state.yaml`
- Module: `MOD-ARCHIMATE`
- ADRs: `ADR-0001`

## Outcome

Optional investigation after semantic profile and Visual ITM/runtime renderer foundations; not guaranteed product feature.
