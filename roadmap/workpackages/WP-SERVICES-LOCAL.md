# WP-SERVICES-LOCAL - Local service-folder convention

## Registry

- Workpackage ID: `WP-SERVICES-LOCAL`
...
Data-plane convention before server-backed jobs.
