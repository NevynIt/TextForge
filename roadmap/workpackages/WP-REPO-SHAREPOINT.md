# WP-REPO-SHAREPOINT - SharePoint-like repository adapter

## Registry

- Workpackage ID: `WP-REPO-SHAREPOINT`
...
Backend-only adapter; frontend remains repository/resource/changeset-based.
