# WP-VITM-LIVE-SYNC-01 - Bidirectional source/visual live sync

## Registry

- Workpackage ID: `WP-VITM-LIVE-SYNC-01`
...
Not part of the first recovery slice. This workpackage owns live source-to-visual and visual-to-source selection mirroring beyond the initial stable-provenance plus navigation floor.
