...
- Workpackage ID: `WP-RENDER-SIGMA`
...
Delivered as the dedicated `@textforge/renderer-sigma` package with an actual Sigma/Graphology surface over resolved Visual ITM graph targets, layout/metric/readability controls, neighbor-focus and match filtering, and visual-to-source navigation back into the editor.
...
Use `validation/checklists/workpackages/WP-RENDER-SIGMA-runtime-renderer.md` plus release-specific evidence.
