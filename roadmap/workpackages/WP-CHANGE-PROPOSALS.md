# WP-CHANGE-PROPOSALS - Reviewable change proposals

## Registry

- Workpackage ID: `WP-CHANGE-PROPOSALS`
...
Turns raw multi-resource changesets into reviewable proposals with comments, approval state, and apply/discard flow. GitLab merge requests and AI patches are adapters/consumers, not the core proposal model.
