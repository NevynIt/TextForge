# WP-PRIVATE-CONTRACT - Private/group space contracts

## Registry

- Workpackage ID: `WP-PRIVATE-CONTRACT`
...
Define early; do not expose UI roots until server enforcement exists.
