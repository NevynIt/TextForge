# WP-RELEASE-GATE - Release envelope and accreditation evidence

## Registry

- Workpackage ID: `WP-RELEASE-GATE`
...
Should recur at milestones, not only at final end.
...
- legacy source: Phase 19 reframed
