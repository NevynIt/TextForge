...
- Workpackage ID: `WP-RENDER-JSMIND`
...
Delivered as the dedicated `@textforge/renderer-jsmind` package with an actual jsMind surface over resolved Visual ITM mindmap targets, explicit expansion modes plus fold/unfold and fit/center controls, drag-pan and zoom controls, search highlighting, and visual-to-source navigation back into the editor.
...
Use `validation/checklists/workpackages/WP-RENDER-JSMIND-runtime-renderer.md` plus release-specific evidence.
...
- legacy source: Old runtime recovery
