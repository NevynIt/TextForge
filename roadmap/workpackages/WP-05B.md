...
Pure document-scoped resolver, deterministic activation ordering, `%require` capability matching, active short-name diagnostics, and shell inspector context landed on top of the validated WP-05A registry.
...
Use `validation/checklists/workpackages/WP-05B-capability-activation-and-resolver-context.md` plus release-specific evidence.
