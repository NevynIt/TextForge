...
Delivered as the dedicated `@textforge/visual-itm` package with concrete Visual ITM v1 helpers, fixture documents, and validation for the constrained node/edge/hierarchy/label/style/provenance/layout/diagnostic contract. Derived targets keep upstream `render:` precedence; standalone/manual documents treat local renderer metadata as authoritative.
...
Use `validation/checklists/workpackages/WP-VITM-01-visual-itm-profile-v1.md` plus release-specific evidence.
