...
| WP-ITM-01 | Phase 6 | ITM parser/model foundation | Domain foundation | Not started | WP-05A recommended | WP-ITM-02, WP-REPO-01, WP-ITM-VISUALS, WP-BPMN-SEM | No | Yes | Owns parse/serialize/resolve/validate/project contracts, selector/style/view/profile interfaces, and diagnostics taxonomy; includes Phase 6 anchor set plus bootstrap dependency action from the ITM package guide; acceptance targets include round-trip, resolver taxonomy, selector/style/view, and profile fixtures. |
