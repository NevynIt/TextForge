...
| WP-ID-DEV | New V18 split | Development identity fixture provider | Development enabler | Not started | WP-ID-01 | WP-POLICY-01, WP-BE-PERSIST, WP-PRIVATE-SERVER, WP-SETTINGS-SYNC | No | No | Local fake users/groups/claims from config. Enables backend development without Entra. |
