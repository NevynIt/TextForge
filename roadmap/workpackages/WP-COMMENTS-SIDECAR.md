# WP-COMMENTS-SIDECAR - Comments and review sidecars

## Registry

- Workpackage ID: `WP-COMMENTS-SIDECAR`
...
Owns comments over source ranges, Markdown preview anchors, and later visual targets. Distinct from sketch/PDF annotation and requires revision-aware diagnostics before implementation.
