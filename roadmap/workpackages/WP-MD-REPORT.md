# WP-MD-REPORT - Markdown + ITM report generation

## Registry

- Workpackage ID: `WP-MD-REPORT`
...
Keeps report generation separate from backend work. May proceed after the validated visual/BPMN baseline, but dashboard visual blocks should use `WP-ITM-PUB-VISUAL-01` when view/viewpoint parity is needed.
