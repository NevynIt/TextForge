# WP-TABLES - Tables, catalogues, and matrices
...
Dependency-ready but held. Do not implement until a dedicated grilling session clarifies diagnostics visualization ownership and entry points, confirms the package boundary, and decides whether CSV/TSV editing should use a pre-existing grid/editor component rather than bespoke table-editing UI.
