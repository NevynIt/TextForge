...
- Workpackage ID: `WP-RENDER-CYTOSCAPE`
...
Delivered as the dedicated `@textforge/renderer-cytoscape` package with an actual Cytoscape surface over resolved Visual ITM graph targets, basic layout/zoom/pan/fit/search/selection/inspector controls, and visual-to-source navigation routed back through the source editor.
...
Use `validation/checklists/workpackages/WP-RENDER-CYTOSCAPE-runtime-renderer.md` plus release-specific evidence.
