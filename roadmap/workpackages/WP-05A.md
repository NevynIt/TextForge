...
Canonical bundled manifest normalization, deterministic registry package read model, dependency/conflict diagnostics, and shell registry inspector landed; document capability activation stays in WP-05B.
...
Use `validation/checklists/workpackages/WP-05A-contribution-manifest-and-registry-model.md` plus release-specific evidence.
