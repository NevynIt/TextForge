# WP-SSO-SAML - Generic SAML / enterprise IdP adapter

## Registry

- Workpackage ID: `WP-SSO-SAML`
- Authoritative state: `roadmap-state.yaml`
- Module: `MOD-SECURITY-DISTRIBUTION`
- ADRs: `ADR-0001`

## Outcome

Same contract as Entra/OIDC; provider-specific mapping stays behind adapter.
