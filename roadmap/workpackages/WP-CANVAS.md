# WP-CANVAS - Spatial workspace canvas

## Registry

- Workpackage ID: `WP-CANVAS`
...
Adds a persisted canvas resource for arranging documents, cards, model views, links, and embedded surfaces. It is not Excalidraw/sketch annotation and must preserve explicit write-back contracts.
