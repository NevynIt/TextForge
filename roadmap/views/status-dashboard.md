...
|---:|---|---|---|---|
| 0 | `WP-ROADMAP-CLEANUP` | Roadmap cleanup and governance reset | validated | `MOD-ROADMAP-GOVERNANCE` |
| 0 | `WP-05A` | Contribution manifest and registry model | validated | `MOD-SURFACES-UI` |
| 0 | `WP-05B` | Capability activation and resolver context | validated | `MOD-SURFACES-UI` |
| 0 | `WP-05C` | Pipeline/contribution execution integration | validated | `MOD-SURFACES-UI` |
| 0 | `WP-05D` | Minimal package/capability inspector | validated | `MOD-SURFACES-UI` |
| 0 | `WP-RES-01` | Provider-aware resource descriptors | validated | `MOD-WORKSPACE-RESOURCES` |
| 0 | `WP-ITM-01` | ITM parser/model foundation | validated | `MOD-ITM` |
| 0 | `WP-ITM-02` | ITM directives, packages, validation, diagnostics | validated | `MOD-ITM` |
| 0 | `WP-ITM-03` | ITM scoped contexts, identity maps, and comments | validated | `MOD-ITM` |
| 0 | `WP-REPO-01` | Repository reference and include resolver | validated | `MOD-REPOSITORY` |
| 0 | `WP-ITM-VISUALS` | ITM static visual projections and publication baseline | validated | `MOD-VISUAL-ITM-RENDERERS` |
| 0 | `WP-VITM-01` | Visual ITM profile v1 | validated | `MOD-VISUAL-ITM-RENDERERS` |
| 0 | `WP-ITM-VTARGET-01` | ITM visual target picker MVP | validated | `MOD-VISUAL-ITM-RENDERERS` |
| 0 | `WP-ITM-VRESOLVE-01` | Shared ITM visual target resolver | validated | `MOD-VISUAL-ITM-RENDERERS` |
| 0 | `WP-RENDER-CYTOSCAPE` | Cytoscape runtime renderer package | validated | `MOD-VISUAL-ITM-RENDERERS` |
| 0 | `WP-RENDER-JSMIND` | jsMind runtime renderer package | validated | `MOD-VISUAL-ITM-RENDERERS` |
| 0 | `WP-RENDER-SIGMA` | Sigma/Graphology runtime renderer package | validated | `MOD-VISUAL-ITM-RENDERERS` |
| 0 | `WP-LUA` | Lua automation | validated | `MOD-SURFACES-UI` |
| 0 | `WP-LUA-POWER-SESSION` | Lua self-escalation session and one-click recovery | validated | `MOD-SURFACES-UI` |
| 0 | `WP-LUA-VIRTUAL-HOST-01` | TextForge Lua virtual host for Fengari | implemented | `MOD-SURFACES-UI` |
| 0 | `WP-BPMN-SEM` | BPMN semantic profile and validation | validated | `MOD-BPMN` |
| 0 | `WP-BPMN-VISUAL-A` | BPMN.io viewer surface | validated | `MOD-BPMN` |
| 0 | `WP-BPMN-DI-01` | BPMN Diagram Interchange read-only fidelity | validated | `MOD-BPMN` |
| 0 | `WP-BPMN-VISUAL-B` | ITM/BPMN visual target integration | validated | `MOD-BPMN` |
...
| 54 | `WP-SSO-ENTRA` | Microsoft Entra SSO adapter | deferred | `MOD-SECURITY-DISTRIBUTION` |
